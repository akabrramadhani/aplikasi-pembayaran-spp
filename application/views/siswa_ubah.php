            ...
            <div class="card card-primary card-outline">
              ...
              <form class="form-horizontal" method="post" action="<?php echo base_url('siswa/update') ?>">
                ...
                <div class="form-group row">
                      ...
                      <div class="col-sm-8">
                        <input type="number" class="form-control" name="id_siswa" placeholder="Id" required>
                      </div>
                    </div>            
                    <div class="form-group row">
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-sm-8">
                        ...
                        <input type="hidden" class="form-control" name="nama" value="<?php echo $value->id_siswa; ?>">
                      </div>
                    </div>
                    <div class="form-group row">
